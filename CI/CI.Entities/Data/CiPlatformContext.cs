...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=PCI212\\SQL2019;Database=CI-platform;Trusted_Connection=True; TrustServerCertificate=True;Encrypt=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA41417E24CB97");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C348BB19245");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A86DF4899C");
            ...
            entity.HasOne(d => d.Country).WithMany(p => p.Cities)
                ...
                .HasConstraintName("FK__city__country_id__29572725");
        });

        modelBuilder.Entity<CmsPage>(entity =>
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52BF386269");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD0558D3E91F0");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favorite__94E4D8CA45FBE34D");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.FavoriteMissions)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__favorite___missi__6D0D32F4");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB2BCAC711B");
            ...
            entity.HasOne(d => d.Theme).WithMany(p => p.Missions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission__theme_i__534D60F1");
        });

        modelBuilder.Entity<MissionApplication>(entity =>
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838A1B7140A8");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionApplications)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_a__missi__797309D9");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC87D834C6B");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionDocuments)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_d__missi__01142BA1");
        });

        modelBuilder.Entity<MissionInvite>(entity =>
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED15872EDDA4B");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionInvites)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_i__missi__06CD04F7");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E83EC4B7AB");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionMedia)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_m__missi__0E6E26BF");
        });
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___827120082C56F99A");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionSkills)
                .HasForeignKey(d => d.MissionId)
                .HasConstraintName("FK__mission_s__missi__22751F6C");

            entity.HasOne(d => d.Skill).WithMany(p => p.MissionSkills)
                .HasForeignKey(d => d.SkillId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__mission_s__skill__2180FB33");
        });

        modelBuilder.Entity<MissionTheme>(entity =>
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5AC0E1FAB94");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA83795688AE0C");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C56CA83A52F");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__04497867797B6D68");
            ...
            entity.HasOne(d => d.Story).WithMany(p => p.StoryInvites)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story_inv__story__3587F3E0");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C90CC93F0");
            ...
            entity.HasOne(d => d.Story).WithMany(p => p.StoryMedia)
                .HasForeignKey(d => d.StoryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__story_med__story__3D2915A8");
        });

        modelBuilder.Entity<Timesheet>(entity =>
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF5068BFB5C0ED");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576BD4D66EFA");
